...
<div class="form-group">
    ...
    <input type="text" class="form-control" name="lastName" value="{{isset($employee->lastName)?$employee->lastName:old('lastName')}}">
</div>
...
<div class="form-group mt-3">
    ...
    <input type="number" class="form-control" name="documentNumber" value="{{isset($employee->documentNumber)?$employee->documentNumber:old('documentNumber')}}">
</div>

<div class="form-group mt-3">
    <label for="phoneNumber">Nro. Celular</label>
    <input type="number" class="form-control" name="phoneNumber" value="{{isset($employee->phoneNumber)?$employee->phoneNumber:old('phoneNumber')}}">
</div>

<div class="form-group">
    <label for="address">Dirección</label>
    <input type="text" class="form-control" name="address" value="{{isset($employee->address)?$employee->address:old('address')}}">
</div>
...
<div class="form-group mt-3">
    ...
    <div class="col-auto">
        <input class="form-control form-control-sm" type="date" value="{{isset($employee->hiringDate)?$employee->hiringDate:old('hiringDate')}}" name="hiringDate" >
    </div>
</div>

<div class="form-group mt-3">
    <label for="salary">Salario</label>
    <input type="number" class="form-control" name="salary" value="{{isset($employee->salary)?$employee->salary:old('salary')}}">
</div>
